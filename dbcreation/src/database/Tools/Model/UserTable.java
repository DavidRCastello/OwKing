...
//		
		sql = "CREATE TABLE  `user` (\n"
                    ...
                    + "`"+this.logo+"` VARCHAR(50) NOT NULL,\n"
                    + "`"+this.finalStatisticsId+"` VARCHAR(36) NOT NULL,\n"
                    + "`"+this.gradeId+"` VARCHAR(36) NOT NULL,\n"
                    + "`"+this.email+"` VARCHAR(50) NOT NULL,\n"
                    + "`"+this.password+"` VARCHAR(18) NOT NULL,\n"
                    + "`"+this.twitter+"` VARCHAR(20) NOT NULL,\n"
                    + "`"+this.twitch+"` VARCHAR(20) NOT NULL,\n"
                    + "`"+this.rightsId+"` VARCHAR(36) NOT NULL,\n"
